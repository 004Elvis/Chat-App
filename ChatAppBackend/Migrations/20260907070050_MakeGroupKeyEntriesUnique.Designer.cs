...
namespace ChatAppBackend.Migrations
{
    ...
    [Migration("20260907070050_MakeGroupKeyEntriesUnique")]
    partial class MakeGroupKeyEntriesUnique
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ChatAppBackend.Models.CallLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ChatAppBackend.Models.EmailVerificationToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ChatAppBackend.Models.GroupKeyEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("DistributorPublicKey")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasIndex("ChatRoomId", "KeyVersion", "UserId")
                        .IsUnique();

                    b.ToTable("GroupKeyEntries");
                });
            ...
            modelBuilder.Entity("ChatAppBackend.Models.CallLog", b =>
                {
                    b.HasOne("ChatAppBackend.Models.User", "Caller")
                        .WithMany()
            ...
            modelBuilder.Entity("ChatAppBackend.Models.Message", b =>
                {
                    ...
                    b.HasOne("ChatAppBackend.Models.Message", "ReplyToMessage")
                        .WithMany()
